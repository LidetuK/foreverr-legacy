      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
              ...
              <div className="flex gap-3">
                {socials.map((s) => (
                  <a
                    ...
                    href={s.href}
                    aria-label={s.label}
                    className="w-10 h-10 rounded-full bg-primary-foreground/10 border border-primary-foreground/20 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors duration-300"
                  >
          ...
          <div>
            <ScrollReveal delay={100}>
              <h4 className="font-semibold mb-4 text-sm uppercase tracking-wider text-primary-foreground/60">Company</h4>
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">About ECKZET</a></li>
                <li><a href="#" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">Visit EXXiiT</a></li>
          ...
          <div>
            <ScrollReveal delay={200}>
              ...
              <ul className="space-y-3 text-sm text-primary-foreground/70">
                <li>support@foreverr.app</li>
                <li className="pt-2 font-semibold text-primary-foreground/50 text-xs uppercase tracking-wider">Global Offices</li>
                <li>New York, USA</li>
                <li>Accra, Ghana</li>
                <li>Tema, Ghana</li>
                <li>Kumasi, Ghana</li>
        ...
        <div className="border-t border-primary-foreground/10 pt-8 text-center">
          <p className="text-xs text-primary-foreground/50">
            © {new Date().getFullYear()} FOREVERR.APP — A product of ECKZET Group. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
